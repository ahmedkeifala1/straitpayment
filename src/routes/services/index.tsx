          ...
          >
            <div className="max-w-4xl mx-auto mb-16">
              ...
              <p className="text-gray-600 mb-8">
                ...
                contemporary solutions and help organisations overcome their
            ...
            <div className="max-w-4xl mx-auto mb-16">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-800 mb-4">
                  ...
                  change projects in your organisation.
                </h3>
                <p className="text-gray-600 mb-6">We can:</p>
                <div className="grid md:grid-cols-2 gap-4">
                  {[
          ...
          <div id="people" className="tab-content" data-aos="fade-up">
            <div className="max-w-4xl mx-auto mb-16">
              ...
              <p className="text-gray-600 mb-8">
                ...
                solution? Is your organisation prepared to learn at the speed of
                need?
              </p>
